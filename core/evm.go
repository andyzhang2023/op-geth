...
var (
	...
	execTransferAccountCanTransfer = metrics.NewRegisteredTimer("exec/transfer/account/can/transfer", nil)
)
...
func CanTransfer(db vm.StateDB, addr common.Address, amount *big.Int) bool {
	defer func(t0 time.Time) { execTransferAccountCanTransfer.UpdateSince(t0) }(time.Now())
